...
## Project Structure
    ...
    ├── test684sa68d4dcdec__46732  # Django project configurations
...
1. Clone this repo and `cd test684sa68d4dcdec__46732`
...
2. Clone this repo and `cd test684sa68d4dcdec__46732`
